...
// llama_cpp_dart ABI shim: rename symbols that collide with the old binding
// surface so the shared library can export both the old ABI (via the shim) and
// modern llama.cpp without duplicate-symbol conflicts.
#include "llama_abi_rename.h"
